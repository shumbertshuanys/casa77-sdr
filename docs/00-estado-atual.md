...
Atualizado em: 2026-09-04 (**reconciliação documental pós-merge da OITAVA MICROENTREGA
FUNCIONAL DE `C` — leitor/validador determinístico da representação marcada `C-A5`**). Esta
...
**Baseline funcional corrente: `2908 passed` / Python 3.14.5.**

**Execuções da PR #102, registro desta entrega** (2026-09-04, Python 3.14.5) — **quatro
...
1. A **sétima microentrega funcional de `C`** — o **canonicalizador determinístico de rótulo
   ...
   funcional mais recente NÃO é mais a do PR #97**: desde o **PR #102** ela é a **oitava
   microentrega funcional de `C` — o leitor/validador determinístico da representação marcada
   `C-A5`**, em `src/casa77_sdr/response_markdown_units.py`, registrada no **item 90**.
   **Nenhuma das oito microentregas materializa
