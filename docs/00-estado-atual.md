...
**Baseline funcional corrente: `2707 passed` / Python 3.14.5.**

**Execuções pós-merge da PR #97, registro desta entrega** (2026-09-02, Python 3.14.5) —
...
1. A **sétima microentrega funcional de `C`** — o **canonicalizador determinístico de rótulo
   ...
   funcional mais recente é a do PR #97.** **Nenhuma das sete microentregas materializa
