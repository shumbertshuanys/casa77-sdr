...
Atualizado em: 2026-09-04 (**reconciliação documental pós-merge da NONA MICROENTREGA
FUNCIONAL DE `C` — derivador determinístico dos tokens canônicos do lado do índice**). Esta
...
**Baseline funcional corrente: `3111 passed` / Python 3.14.5.**
...
1. A **sétima microentrega funcional de `C`** — o **canonicalizador determinístico de rótulo
   ...
   funcional mais recente NÃO é mais a do PR #97**: desde o **PR #104** ela é a **nona
   microentrega funcional de `C` — o derivador determinístico dos tokens canônicos do lado do
   índice**, em `src/casa77_sdr/response_index_tokens.py`, registrada no **item 91**; a
   ...
   **Nenhuma das nove microentregas materializa
