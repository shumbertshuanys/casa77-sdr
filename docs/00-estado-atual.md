...
Não existe PR nem merge desta arbitragem; ela **não cria marco funcional** e não altera o
último commit funcional (`02dcb477…`) nem o último marco funcional (**3B.5**). A **3B.6
continua NÃO iniciada e NÃO autorizada**.
