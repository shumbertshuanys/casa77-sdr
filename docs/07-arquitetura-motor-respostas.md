...
| D8P-16 | **Escopo isolado.** Materializar este produtor **não** cria o conteúdo de `R2`, **não** cria `knowledge/mapa-cobertura.yaml`, **não** integra a etapa 10 *end-to-end*, **não** implementa o `OrquestradorMotor` e **não** confirma evento algum. **Sem o conteúdo aprovado do mapa, a cobertura real continua não operacional.** |
