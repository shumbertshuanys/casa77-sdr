...
O que a materialização **não** faz: **N-a-T3–N-a-T7 continuam NÃO implementadas** — a
**escrita** do marco temporal e a **composição entre as até três chamadas** do ciclo (regra
7) pertencem ao chamador da etapa 13 e **não existem em código** —, e o
