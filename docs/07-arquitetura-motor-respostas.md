...
**N-a** (item 18) e pelo **destino do alerta** (item 3a). O **tratamento operacional dos
bloqueios `S4`/`S5`** **deixou de ser decisão arquitetural aberta**: ele está **arbitrado**
em §7.1 (**`TS45-1`**–**`TS45-20`**). O que resta dele é a **materialização em runtime**,
que pertence ao mesmo `OrquestradorMotor` — **arbitrar não é materializar**.
